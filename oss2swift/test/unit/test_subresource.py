...
from oss2swift.response import AccessDenied, InvalidArgument, OssNotImplemented
from oss2swift.subresource import User, AuthenticatedUsers, AllUsers, \
...
from oss2swift.utils import CONF, sysmeta_header
from swift.common.utils import json


class TestOss2swiftSubresource(unittest.TestCase):
    ...
    def test_base_grantee(self):
        ...
        self.assertRaises(OssNotImplemented, func)
