...
from oss2swift.acl_handlers import OssAclHandler, BucketAclHandler, \
...
class TestAclHandlers(unittest.TestCase):
    ...
    def test_handle_acl(self):
        # we have already have tests for oss_acl checking at test_oss_acl.py
        pass
