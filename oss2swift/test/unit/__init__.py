...
from oss2swift.middleware import Oss2Swift
...
class FakeApp(object):
    ...
    def _update_oss_path_info(self, env):
        """
        For oss requests, Swift auth middleware replaces a user name in
    ...
    def __call__(self, env, start_response):
        if 'HTTP_AUTHORIZATION' in env:
            self._update_oss_path_info(env)

        return self.swift(env, start_response)


class Oss2swiftTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.oss2swift = Oss2Swift(self.app, CONF)
    ...
    def _test_method_error(self, method, path, response_class, headers={}):
        ...
        headers.update({'Authorization': 'OSS test:tester:hmac',
    ...
    def get_v4_oss_date_header(self):
    ...
    def call_oss2swift(self, req, **kwargs):
        return self.call_app(req, app=self.oss2swift, **kwargs)
