...
class Oss2swiftFunctionalTestCase(unittest.TestCase):
    def __init__(self, method_name):
        super(Oss2swiftFunctionalTestCase, self).__init__(method_name)
    ...
    def assertCommonResponseHeaders(self, headers, etag=None):
        ...
        """
        self.assertTrue(headers['x-oss-id-2'] is not None)
        self.assertTrue(headers['x-oss-request-id'] is not None)
