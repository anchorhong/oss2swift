"""
Implementation of OSS Multipart Upload.

This module implements OSS Multipart Upload APIs with the Swift SLO feature.
The following explains how oss2swift uses swift container and objects to store OSS
upload information:
...
from oss2swift.exception import BadSwiftRequest
from oss2swift.response import InvalidArgument, ErrorResponse, MalformedXML, \
    InvalidPart, BucketAlreadyExists, EntityTooSmall, InvalidPartOrder, \
    InvalidRequest, HTTPOk, HTTPNoContent, NoSuchKey, NoSuchUpload, \
    NoSuchBucket
from oss2swift.utils import LOGGER, unique_id, MULTIUPLOAD_SUFFIX, OssTimestamp
...
MAX_COMPLETE_UPLOAD_BODY_SIZE = 4096 * 1024
...
class PartController(Controller):
    ...
    Those APIs are logged as PART operations in the OSS server log.
    """
    @public
    @object_operation
...
class UploadsController(Controller):
    ...
    Those APIs are logged as UPLOADS operations in the OSS server log.
    """
    @public
...
class UploadController(Controller):
    ...
    Those APIs are logged as UPLOAD operations in the OSS server log.
    """
    @public
    @object_operation
    @check_container_existence
