...
"""
The Oss2Swift middleware will emulate the OSS REST api on top of swift.
...
To add this middleware to your configuration, add the Oss2Swift middleware
...
from oss2swift import __version__ as oss2swift_version
from oss2swift.cfg import CONF
from oss2swift.exception import NotOssRequest
from oss2swift.request import get_request_class
from oss2swift.response import ErrorResponse, InternalError, MethodNotAllowed, \
    ResponseBase
...
class Oss2Swift(object):
    """Oss2Swift compatibility middleware"""
    ...
    def check_pipeline(self, conf):
        ...
        auth_pipeline = pipeline[pipeline.index('oss2swift') + 1:
...
def filter_factory(global_conf, **local_conf):
    ...
    register_swift_info(
        ...
        version=oss2swift_version,
    )

    def oss2swift_filter(app):
        return Oss2Swift(app, CONF)

    return oss2swift_filter
